...
Here are some lectures in C++ for Programming Abstractions focused in basic spatial problems based on the course of [SEE](https://see.stanford.edu/Course/CS106B) by Julie Zelenski and the book Programming Abstractions in C++ by Eric Roberts.
